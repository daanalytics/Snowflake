...
# Location for the F1-demo files from Kaggle
file_location = '<Local file location>'


# Download files from Kaggle 
#api.dataset_download_files('rohanrao/formula-1-world-championship-1950-2020', path=file_location)

# Download files from Kaggle 
api.dataset_download_files('<Kaggle file>', path=file_location, unzip=True)

# Unzip downloaded zipfile
# from zipfile import ZipFile
# zf = ZipFile('formula-1-world-championship-1950-2020.zip')
# zf.extractall(file_location) # Save files into selected folder
# zf.close()
